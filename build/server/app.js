...
var convert = (function (p1__7308_SHARP_){
return (hackday.app.numerals.call(null,cljs.core.mod.call(null,p1__7308_SHARP_,10)) + hackday.app.rows.call(null,cljs.core.int$.call(null,(p1__7308_SHARP_ / 10))));
});
...
var stdin = cljs.nodejs.process.stdin;
...
var to_braile = (function (p1__7309_SHARP_){
return shift_register.send(hackday.app.latin__GT_braile.call(null,p1__7309_SHARP_));
});
...
var G__7311 = stdin;
G__7311.setRawMode(true);
G__7311.resume();
G__7311.setEncoding("utf8");
G__7311.on("data",to_braile);
return G__7311;
}));
});
