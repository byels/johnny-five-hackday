...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t1302) {
      cljs.core.t1302 = {};
      cljs.core.t1302 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta1303 = c;
      ...
      cljs.core.t1302.cljs$lang$type = !0;
      cljs.core.t1302.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t1302")
      };
      cljs.core.t1302.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t1302")
      };
      var c = cljs.core.t1302.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t1302.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t1302.prototype.cljs$core$Fn$ = !0;
      cljs.core.t1302.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta1303
      };
      cljs.core.t1302.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t1302(this.meta, this.f, b)
      }
    }
    return new cljs.core.t1302(b, a, null)
  }(), b)
};
...
var gcljs = {server:{}};
gcljs.server.lib = {};
gcljs.server.lib.redis = {};
gcljs.server.lib.redis.client = cljs.nodejs.require.call(null, "redis").createClient();
gcljs.server.lib.redis.get = function(a, b) {
  return gcljs.server.lib.redis.client.get(a, b)
};
gcljs.server.lib.redis.set = function(a, b) {
  return gcljs.server.lib.redis.client.set(a, b)
};
var hackday = {app:{}};
hackday.app.numerals = cljs.core.PersistentVector.fromArray([1, 3, 9, 25, 17, 11, 27, 19, 10, 26], !0);
hackday.app.rows = cljs.core.PersistentVector.fromArray([0, 4, 36, 32], !0);
hackday.app.latin__GT_braile = function(a) {
  var a = a.toUpperCase().charCodeAt(0) - 65, b = function(a) {
    return hackday.app.numerals.call(null, cljs.core.mod.call(null, a, 10)) + hackday.app.rows.call(null, cljs.core.int$.call(null, a / 10))
  };
  var c = 25 < a;
  return(c ? c : 0 > a) ? 0 : 22 < a ? b.call(null, a - 1) : cljs.core._EQ_.call(null, a, 22) ? b.call(null, 39) : b.call(null, a)
};
hackday.app._main = function() {
  var a = cljs.nodejs.require.call(null, "johnny-five"), b = cljs.nodejs.process.stdin, c = new a.Board;
  return c.on("ready", function() {
    var d = new a.ShiftRegister(cljs.core.clj__GT_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'pins"], {"\ufdd0'pins":cljs.core.ObjMap.fromObject(["\ufdd0'data", "\ufdd0'clock", "\ufdd0'latch"], {"\ufdd0'data":2, "\ufdd0'clock":3, "\ufdd0'latch":4})}))), e = function(a) {
      return d.send(hackday.app.latin__GT_braile.call(null, a))
    };
    c.repl.inject(cljs.core.clj__GT_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'shiftRegister", "\ufdd0'toBraile"], {"\ufdd0'shiftRegister":d, "\ufdd0'toBraile":e})));
    b.setRawMode(!0);
    b.resume();
    b.setEncoding("utf8");
    b.on("data", e);
