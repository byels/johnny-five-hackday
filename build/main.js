...
hackday.app._main = function() {
  var a = cljs.nodejs.require.call(null, "johnny-five"), b = new a.Board;
  return b.on("ready", function() {
    var c = new a.ShiftRegister(cljs.core.clj__GT_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'pins"], {"\ufdd0'pins":cljs.core.ObjMap.fromObject(["\ufdd0'data", "\ufdd0'clock", "\ufdd0'latch"], {"\ufdd0'data":2, "\ufdd0'clock":3, "\ufdd0'latch":4})}))), d = function(a) {
      return c.send(hackday.app.latin__GT_braile.call(null, a))
    };
    b.repl.inject(cljs.core.clj__GT_js.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'shiftRegister", "\ufdd0'toBraile"], {"\ufdd0'shiftRegister":c, "\ufdd0'toBraile":d})));
    var e = cljs.nodejs.process.stdin;
    e.setRawMode(!0);
    e.resume();
    e.setEncoding("utf8");
    e.on("data", function(a) {
      return cljs.core._EQ_.call(null, a, "\u0003") ? cljs.nodejs.process.exit() : d.call(null, a)
    });
    return e
  })
};
